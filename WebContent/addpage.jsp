                    ...
                    <div class="content-wrapper">
                        <div class="container-fluid">
                            <div class="card mb-3">
                                ...
                                <form method="post" action="add.jsp" name="form1">

                                    <div class="table-responsive" >
                                        <table class="table" id="dataTable" width="100%">
                                            <tr>
                                                <td>
                                                    <label for="email">ItemID</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="pwd">Supplier contact</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="submit" class="btn btn-primary" name="btn1">Insert</button>
                                                </td>
                                            </tr>
